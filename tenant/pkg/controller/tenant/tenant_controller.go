...
import (
	...
	tenantv1alpha1 "github.com/multi-tenancy/tenant/pkg/apis/tenant/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &tenantv1alpha1.Tenant{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &tenantv1alpha1.Tenant{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=tenant.k8s.io,resources=tenants,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=tenant.k8s.io,resources=tenants/status,verbs=get;update;patch
func (r *ReconcileTenant) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Tenant instance
	instance := &tenantv1alpha1.Tenant{}
